...
В методе handle класса ParserOEM выбирается парсер в зависимости от сайта. Полученные данные записываются в базу данных.



SiteBaseOem.php

Класс SiteBaseOem имеет общие для всех парсеров методы логирования ошибок, нахождения адреса, телефона, имени филиала/фирмы, получния данных сайта из базы данных и т.д.
